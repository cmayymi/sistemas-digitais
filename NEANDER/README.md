...
Este repositório contém todos os arquivos descritivos e arquivos de teste utilizados/criados durante o processo de implementação do **Computador Teórico Neander**, desenvolvido na parte final da disciplina de **Sistemas Digitais**.
